...
In this research will be given a frame to this new type of music called 'Kizomba'. It was created in the 70s/80s and means 'party' in Angolan. In this project is researched what is specific about kizomba music. We will use three recent made playlists of Kizomba, Bachata and Pop. All have been created and updated in the last two weeks. We will compare and look at the energy-levels, modes, loudness and valence. 

Then we will look at four popular songs in more detail. Two versions of 'Sad Girlz Luv Money', the orginal and the kizomba remix version will be compared with each other looking at the chroma features with the use of two chromagrams and a self-similarity matrice with chroma features.   ‘love nwantiti’ for CKay. 
