...
### Sad Girlz luv Money kizomba version
...
### Chroma self-similaritymatrice "Sad Girlz Luv Money' Kizomba version
...
## Build-up of the song 

From 0 to 9 seconds there is an intro with guitar and wordless singing. At 9 seconds there is a transition with a drum ruffle. He starts singing the first verse. At 20 seconds we have another drum ruffle and a more steady beat comes in. At 31 seconds starts the chorus. At 41 seconds the post chorus starts with backing vocals and autotunish vocal effect. At 1.02 the second chorus starts. At 1.22 the second chorus starts. At 1.32 the second postchorus comes in. At 1.53 the bridge starts. At 2.14 the outro starts.At 2.19 there are some words sung again. 

The structure of the song is:
000   INTRO - 009 VERSE1 - 031 CHORUS1 - 041 POSTCHORUS1 - 062 VERSE2 - 082 CHORUS2 - 092 POSTCHORUS2 -113 VERSE3 - 134 OUTRO

In this graph we see the magnitude of the effects. c01 to c06 is colored more yellow and green, which means the magnitude is higher. c07 to c12 iw colered bue, which means the magnitude is lower. 

At 42 seconds we see some bright yellow accents, and at 92 seconds we see those accents again. When c01 is accented with a higher magnitude, the same goes for c03. 

The magnitude of c05 varies a lot throughout the song, it is not gradient as we see in c01, c02 and c04. It is a clear striped pattern. For this song we can say that timbre features from c01 to c06 are used a lot and c07 to c12 are not used that much. c05 is used in the beginning and outro. 
...
In this Fourier-based tempogram Spotfy makes an to analyse the tempo of No Maka’s ‘Sextou’. The tempo is estimated at 144 The lines above and below are called tempo octaves. The spaces inbetween the tempo octaves is where there is a freer form.   
